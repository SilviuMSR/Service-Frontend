                        ...
                        <div className={classes.expandedContainerItem}>
                            <div className={this.props.classes.options}>
                                ...
                                <div className={this.props.classes.optionsContainer}>
                                    <Button color="primary" className={classes.acceptIcon} onClick={() => this.props.modifyStatus(this.props.reservation._id, CONSTANTS.RESERVATION_DONE, this.props.login.userId)}>YES</Button>
                                </div>
                            </div>
                        </div>
                    </div>
